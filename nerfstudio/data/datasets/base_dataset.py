...
from nerfstudio.data.utils.data_utils import get_image_mask_tensor_from_path,get_image_depth_tensor_from_path,get_image_semantics_tensor_from_path
...
class InputDataset(Dataset):
    ...
    def __init__(self, dataparser_outputs: DataparserOutputs, scale_factor: float = 1.0):
        ...
        self.has_depth =dataparser_outputs.depths is not None
        self.has_semantics = dataparser_outputs.semantics is not None
    ...
    def get_data(self, image_idx: int) -> Dict:
        ...
        if self.has_semantics:
            semantics_filepath = self._dataparser_outputs.semantics[image_idx]
            data["semantics"] = get_image_semantics_tensor_from_path(filepath=semantics_filepath, scale_factor=self.scale_factor)

        if self.has_depth:
            depth_filepath = self._dataparser_outputs.depths[image_idx]
            data["depth"] = get_image_depth_tensor_from_path(filepath=depth_filepath, scale_factor=self.scale_factor) 
