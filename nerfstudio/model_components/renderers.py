...
class RGBRenderer(nn.Module):
    ...
    def combine_rgb(
        ...
        bg_color: TensorType["bs":..., "num_samples", 3],
    ...
    def forward(
        ...
        rgb = self.combine_rgb(
            rgb, weights, background_color=self.background_color, ray_indices=ray_indices, num_rays=num_rays,bg_color=bg_color,fg_accumulation=fg_accumulation
        )
